...
export default function Tasks() {
  ...
  useEffect(() => {
    ...
    fetch(`http://localhost:5000/api/tasks/${user.id}`)
      .then((res) => {
  ...
  return (
    <div>
      ...
      {dateFilter && (
        ...
        >
          <span>
            📅 Showing tasks for: <strong>{formatDate(dateFilter)}</strong>
          </span>
          <button
            className="btn btn-secondary btn-sm"
            onClick={() => setDateFilter("")}
      ...
      {filtered.length === 0 ? (
        <div className="empty-state">
          ...
          <div className="empty-text">
            No tasks found. Try a different filter or add a new one!
          </div>
        </div>
      ) : (
        filtered.map((t, i) => {
          ...
          return (
            ...
            >
              ...
              {t.fileName && (
                ...
                >
                  📎{" "}
                  {t.fileName.length > 15
                    ? t.fileName.slice(0, 15) + "..."
                    : t.fileName}
                </span>
              )}
        ...
        >
          ...
          >
            ...
            >
              ...
              <span
                className={`badge ${viewingTask.done ? "badge-low" : "badge-medium"}`}
              >
              ...
              <div style={{ display: "flex", justifyContent: "space-between" }}>
                <div>
                  ...
                  <div
                    style={{
                      fontWeight: 500,
                      color: isOverdue(viewingTask.date, viewingTask.done)
                        ? "var(--red)"
                        : "inherit",
                    }}
                  >
