...
const INITIAL_NOTICES = [
  {
    ...
    description:
      "The mid-semester examination timetable has been published. Check the portal for subject-wise schedule.",
    date: "2026-03-26",
  },
  {
    id: 2,
    ...
    description:
      "AI Hackathon 2026 registrations are now open. Team size: 2-4. Last date: March 31.",
    date: "2026-03-25",
  },
];
    ...
    <div>
      ...
      <div className="summary-grid">
        <StatCard
          delay={1}
          icon="📋"
          iconBg="linear-gradient(135deg,rgba(124,58,237,0.3),rgba(124,58,237,0.1))"
          value={total}
          label="Total Tasks"
        />
        <StatCard
          ...
          {events.slice(0, 3).map((e) => {
            ...
            return (
              <div
                ...
                style={{ padding: "0.7rem", marginBottom: "0.5rem" }}
              >
